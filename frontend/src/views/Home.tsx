...
const Home: React.FC = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className={`${isDarkMode ? 'bg-gray-800' : 'bg-gradient-to-br from-blue-50 to-indigo-100'} py-20`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className={`text-4xl font-extrabold ${isDarkMode ? 'text-white' : 'text-blue-900'
              }`}>
          ...
          <div className="mt-8 grid gap-10 lg:grid-cols-3 sm:grid-cols-2">
            {[
              {
                name: 'Alex Johnson',
              ...
              <div
                key={index}
                className={`rounded-xl shadow-xl p-8 transform hover:scale-105 transition-all duration-300 ${isDarkMode
              ...
              >
                ...
                <div className={`mt-6 pt-6 border-t ${isDarkMode ? 'border-gray-700' : 'border-gray-200'
                  ...
                  <a
                    href="#"
                    className={`inline-flex items-center text-sm font-medium ${isDarkMode
